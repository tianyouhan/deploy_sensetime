...
class GACBaiduDatasetPVBVolc(DatasetTemplateSeg):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        def kitti_eval(eval_det_annos, eval_gt_annos):
            ...
            ap_result_str, ap_dict = kitti_eval.get_official_eval_result(
                ...
                overlap_0_7=overlap_0_7,overlap_0_5=overlap_0_5, class_to_name=class_to_name, valid_classes=['Car', 'Pedestrian', 'Cyclist', 'Truck']
            )
