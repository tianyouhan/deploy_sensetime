...
class GACBaiduDatasetVolc(DatasetTemplateSeg):
    ...
    def prepare_pp_heavy_gt(self, data_dict):
        ...
        if self.training:
            ...
            # print('in dataset target assign_v2')
    ...
    def __getitem__(self, index):
        ...
        # import ipdb; ipdb.set_trace()
        data_dict = self.prepare_data(data_dict=input_dict) # yaw + pi
