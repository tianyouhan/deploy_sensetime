...
import os
import math
class pp_heavy_head_pvbgop_qat(nn.Module):
    def __init__(self,
                 cfg,
                 dataset,
                 num_class=2,
        ...
        """
        super(pp_heavy_head_pvbgop_qat, self).__init__()
        self.cnt = 0
    ...
    def predict_rpn(self, input_dict, preds_dict):
        ...
        for box_preds, cls_preds, dir_preds, iou_preds, var_preds, a_mask in zip(
            ...
            if cfg.FPGA_NMS:
                ...
                print("cfg.RPN_STAGE.USE_ROTATED_NMS: ", cfg.RPN_STAGE.USE_ROTATED_NMS)
                selected_boxes_ls = []
                selected_labels_ls = []
                selected_scores_ls = []
                selected_dir_ls = []
                ...
                for k in range(len(cfg.CLASS_NAMES)):
                    ...
                    boxes_for_nms_[:, 6] *= -1
                    # boxes_for_nms_[:, 6] += torch.tensor(math.pi)
