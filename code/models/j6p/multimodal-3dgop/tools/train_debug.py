...
def parse_config():
    ...
    parser.add_argument('--with_head', type=bool, default=True, help='whether load dense head params')
    parser.add_argument('--with_multi_head', type=bool, default=False, help='whether load multi dense head params')
    ...
    parser.add_argument('--ckpt_save_time_interval', type=int, default=10000, help='in terms of seconds')
...
def main():
    ...
    debugpy.listen(("10.5.36.252", 14458))
    ...
    start_epoch = it = 0
    last_epoch = -1
    if args.load_from_cam is not None:
