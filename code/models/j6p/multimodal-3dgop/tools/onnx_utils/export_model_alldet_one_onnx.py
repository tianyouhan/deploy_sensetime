...
if __name__ == '__main__':
    ...
    cfg_file = "/mnt/lustre/xuzhiyong/code/multimodal-3dgop-xuzhiyong/tools/onnx_utils/checkpoints/MM3DGOP-A02-V1.9-3heads_A02_3dgop_alldet_2V_V1.9_No1/fusion_A02_3dgop_alldet_2V_V1.9_No1_3heads_8m.yaml"
    checkpoint_path = "/mnt/lustre/xuzhiyong/code/multimodal-3dgop-xuzhiyong/tools/onnx_utils/checkpoints/MM3DGOP-A02-V1.9-3heads_A02_3dgop_alldet_2V_V1.9_No1/checkpoint_epoch_40_3heads.pth"  # 在这里指定checkpoint_path
    save_onnx_root = "/mnt/lustre/xuzhiyong/code/multimodal-3dgop-xuzhiyong/tools/onnx_utils/onnx_output/MM3DGOP-A02-V1.9_alldet-8m_one"
    batch_dict = {
            ...
            "gridsample_ref_points": torch.rand(2, 3840, 1, 1, 15, 2, dtype=dtype, device=device),  # cam-atttransform ref_points input
            "gridsample_indexes": torch.rand((2, 3840), dtype=dtype, device=device) * 1000,  # cam-atttransform input, 参考点对应的3840中index
            "gridsample_indexes_valid_flag": torch.cat([torch.ones((2, 3578), dtype=dtype, device=device), torch.zeros((2, 3840-3578), dtype=dtype, device=device)], dim=1),  # cam-atttransform input, 1 for valid
    ...
    onnx_inputs = [
        ['vfe_input', 'voxel_coords', 'voxel_valid_flag'],
        ['center_camera_fov120', 'center_camera_fov30', 'gridsample_ref_points', 'gridsample_indexes', 'gridsample_indexes_valid_flag', 'ref_points_valid_num'],
