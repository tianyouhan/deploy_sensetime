...
## train
# srun -p ${PARTITION} -w SH-IDC1-10-5-36-[226-229,242,243,245,246] \
#     --job-name=train \
#     --ntasks=64 \
#     --gres=gpu:8 \
#     --ntasks-per-node=8 \
...
#         --load_from_cam ../output/A02/camera_A02_3dgop_seg_det_2V_V1.9_No1/default/ckpt/checkpoint_epoch_37.pth \
#         --pretrained_model ../output/A02/lidar_A02_3dgop_seg_det_2V_V1.9_No1/default/ckpt/checkpoint_epoch_59.pth
