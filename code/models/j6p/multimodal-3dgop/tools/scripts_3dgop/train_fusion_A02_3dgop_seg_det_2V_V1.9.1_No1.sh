...
srun -p ${PARTITION} \
    ...
    python -u train.py \
        --launcher slurm \
        --tcp_port 13592 \
        --cfg_file=cfgs/A02/fusion_A02_3dgop_seg_det_2V_V1.9.1_No1.yaml \
        --workers 1 \
        --eval_type "seg_det" \
        --sync_bn \
        --fup \
        --output_folder output \
        --load_from_cam ../output/A02/camera_A02_3dgop_seg_det_2V_V1.9.1_No1/default/ckpt/checkpoint_epoch_40.pth \
        --pretrained_model ../output/A02/lidar_A02_3dgop_seg_det_2V_V1.9.1_No1/default/ckpt/checkpoint_epoch_56.pth
